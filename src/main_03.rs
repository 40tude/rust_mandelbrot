// main_03
// Not a success.
// Try another color palette in mandelbrot_color()
// Inside black, outside blue
...
fn main() {
    ...
    save_image("./assets/image_rgb_03.png", &image, width, height).expect("Failed to save image");
}
...
fn mandelbrot_color(c: &Complex<f64>) -> (u8, u8, u8) {
    ...
    if z.norm_sqr() > 4.0 {
        ...
        let b = 255 - (255.0 * (i as f64 / ITERATIONS as f64)) as u8;
        (0, 0, b) // blue
    } else {
        (0, 0, 0) // black
    }
